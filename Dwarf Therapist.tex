...
replaced as the default by the more polished ``Labors Alt'' view, written over the course of this guide
...
selected for my starting set. Dwarves which reach legendary status in at least one skill will have their
names displayed in boldface. to distinguish them from their ``lesser'' brethren.
...
window, and stows it away where you tell it. Baically an extended version of the \texttt{PRNT SCR}
...
%TODO Update this section to use the new view once I have a large enough fortress.
...
\newpage
%TODO Verify that the issue of sharpness is still present in the current iteration of Dwarf Therapist.
...
Another way to tweak your dwarves using roles is to use the ``Roles'' view.%TODO
...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{Sec5Fig5}
\end{figure}
